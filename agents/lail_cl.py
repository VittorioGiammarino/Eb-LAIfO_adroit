...
from utils_folder.utils_dreamer import Bernoulli, default, RandomApply
...
class LailClAgent:
    ...
    def select_aug_type(self, aug_type, apply_aug, obs_shape):
        ...
        if aug_type == 'brightness':
            ...
            if self.CL_data_type == 'agent':
                DEFAULT_AUG = torch.nn.Sequential(T.ColorJitter((0.5, 2), None, None, None))
    ...
    def update(self, replay_iter, replay_iter_expert, step):
        ...
        metrics.update(self.update_CL(obs, obs_e_raw, self.check_every_steps, step))
